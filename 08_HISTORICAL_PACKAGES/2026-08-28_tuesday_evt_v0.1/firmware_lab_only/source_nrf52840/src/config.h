...
#define CODEC_OPUS_BITRATE 16000
/* Fixed 16 kb/s is the storage/runtime worst-case contract; silence may still
 * be shortened by Opus DTX without dropping the recording timeline. */
#define CODEC_OPUS_VBR 0
