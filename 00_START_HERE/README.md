...
| # | File | Why |
|---|---|---|
| 0 | [`ORIENTATION.md`](ORIENTATION.md) | **New to the project? Start here.** What the product is, where it really stands, how to open every file type, the vocabulary explained, and a suggested first week. Assumes no prior context. |
